...
import { type CreateArtisanForm, createArtisanSchema } from '@/admin-schemas/artisan';

const ALLOWED_MIME_TYPES = ['image/png', 'image/jpeg'];

export default function ArtisanCreate() {
  ...
  return (
    <div className="p-4 md:p-8">
      <FadeIn>
        <div className="mb-6">
          <Link href="/admin/artisans" className="text-sm text-primary hover:underline">
            ← Voltar para artesãs
          </Link>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <Button variant="outline" asChild className="w-full sm:w-auto">
                  <Link href="/admin/artisans">Cancelar</Link>
                </Button>
              </div>
            </form>
          </Form>
